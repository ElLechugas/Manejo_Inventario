        ...
        public List<Cliente> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    ...
                    query.AppendLine("select c.IdCliente,c.Documento,c.NombreCompleto,c.Correo,c.Telefono,c.Estado from Cliente c");
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine("Error en CD_Cliente.Listar(): " + ex.ToString());
