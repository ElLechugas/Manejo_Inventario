        ...
        public List<Proveedor> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    ...
                    query.AppendLine("select p.IdProveedor,p.Documento,p.RazonSocial,p.Correo,p.Telefono,p.Estado from Proveedor p");
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine("Error en CD_Proveedor.Listar(): " + ex.ToString());
